        ...
        const ECO = { bblPerKl: 6.2898, jualKl: 7600000, jualTon: 10400000, hppTon: 9500000, bonusPesanan: 0.06, bonusJarakPerKm: 0.0008, jarakBonusCapKm: 275, gajiSupir: [4500000, 30000], gajiKernet: [3500000, 20000], gajiMekanik: [4000000, 25000], gajiNahkoda: [6000000, 45000], gajiABK: [3800000, 22000], biayaKirimKl: 350000, biayaKirimTon: 500000 };
        let totalIncome = 0;
        let totalExpense = 0;
...
['Sulawesi Selatan','SS',[['Makassar',-5.1477,119.4327,7],['Gowa',-5.2159,119.4497,4],['Maros',-4.9887,119.5713,3],['Parepare',-4.0135,119.6255,3]]],
        ...
        // BBM disamakan dengan LPG (300 km) - SPBU yang jauh dari Kilang Pusat Tuban (mis. Jember) TIDAK dianggap
        // terjangkau sampai ada TBBM/Depo cabang BBM yang lebih dekat dibuka.
        const MAX_SERVICE_KM = { LPG: 300, BBM: 300 };
        ...
        function convertBblSemuaJenis(kilangId) {
            ...
            showModal('Konversi Massal Dimulai', `${kilang.nama} mulai mengolah BBL mentah jadi semua jenis BBM sekaligus: ${ringkasan}. Proses tiap jenis tetap berjalan sesuai durasinya masing-masing (tidak instan) - tunggu sampai badge "Diolah" hilang.`, 'fa-industry', 'blue');
        }
        ...
        function dispatchToSpbu() {
            ...
            const d = { spbu, truck, driver, kernet, origin, jenisMuatan: fuelType, hargaPerUnit: ECO.jualKl, routeMode };
        ...
        function dispatchLPGToSpbu() {
            ...
            const d = { spbu, truck, driver, kernet, jenisMuatan: lpgType, hargaPerUnit: ECO.jualTon, routeMode: routeModeLpg };
        ...
        async function updateRouteEstimate(prefix) {
            ...
            const modeInput = document.querySelector(`input[name="${prefix}-route-mode"]:checked`);
            const routeKey = modeInput ? modeInput.value : 'tol';
            ...
            if (!spbu || !truck) { box.innerHTML = 'Pilih SPBU &amp; armada untuk melihat estimasi jarak, BBM &amp; tol.'; return; }
            const origin = pickOrigin(truck.type, spbu, truck.cap, truck);
            if (!origin) { box.innerHTML = '<span class="text-amber-400">Tidak ditemukan kilang/depo asal yang cocok untuk kombinasi ini.</span>'; return; }
